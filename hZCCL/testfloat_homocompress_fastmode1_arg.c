...
int main(int argc, char *argv[])
{
    ...
    if (argc != 5)
    {
        printf("Usage: testfloat_homocompress_fastmode1_arg [srcFilePath] [srcFilePath2] [blockSize] [relErrBound]\n");
        exit(0);
    }
    ...
    double initial_com_cost = 0.0, normal_decom_cost = 0.0, normal_cpt_cost = 0.0, normal_com_cost = 0.0, normal_total_cost = 0.0, homo_total_cost = 0.0;
    ...
    printf("Traditional DOC workflow (decompression+operation+compression) performance: time: %f s, throughput: %f GBps\n", normal_total_cost, nbEle*sizeof(float)/normal_total_cost/1000/1000/1000);
    ...
    printf("hZ-dynamic performance: time: %f s, throughput: %f GBps\n", homo_total_cost, nbEle*sizeof(float)/homo_total_cost/1000/1000/1000);
