...
int main(int argc, char *argv[])
{
             ...
             size *= 2)
        {
                ...
                if (world_rank == 0)
                {
                        if (PRINT_AVGRESULTS)
                        {
                                printf("Compression-accelerated Kernel %d For datasize: %ld bytes, the avg_time is %f us, the max_time is %f us, the min_time is %f us\n",
