...
size_t Jiajun_save_fixed_length_bits(unsigned int *unsignintArray,
        ...
        switch (remainder_bit) {
            case 1:
                Jiajun_convertUInt2Byte_fast_1b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            case 2:
                Jiajun_convertUInt2Byte_fast_2b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            case 3:
                Jiajun_convertUInt2Byte_fast_3b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            case 4:
                Jiajun_convertUInt2Byte_fast_4b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            case 5:
                Jiajun_convertUInt2Byte_fast_5b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            case 6:
                Jiajun_convertUInt2Byte_fast_6b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            case 7:
                Jiajun_convertUInt2Byte_fast_7b_args(
                    unsignintArray, intArrayLength, result + byte_offset);
                break;
            default:
...
size_t
convertInt2Byte_fast_1b_args(unsigned char *intArray, size_t intArrayLength, unsigned char *result)
{
    size_t byteLength = 0;
    size_t i, j;
...
size_t Jiajun_convertUInt2Byte_fast_1b_args(unsigned int *intArray,
    size_t intArrayLength,
    unsigned char *result)
{
    size_t byteLength = 0;
...
size_t Jiajun_convertUInt2Byte_fast_2b_args(unsigned int *timeStepType,
...
size_t Jiajun_convertUInt2Byte_fast_3b_args(unsigned int *timeStepType,
    size_t timeStepTypeLength,
    unsigned char *result)
{
...
size_t Jiajun_convertUInt2Byte_fast_4b_args(unsigned int *timeStepType,
    size_t timeStepTypeLength,
    unsigned char *result)
{
...
size_t Jiajun_convertUInt2Byte_fast_5b_args(unsigned int *timeStepType,
    size_t timeStepTypeLength,
    unsigned char *result)
{
    size_t i = 0, k = 0, byteLength = 0, n = 0;
...
size_t Jiajun_convertUInt2Byte_fast_6b_args(unsigned int *timeStepType,
    size_t timeStepTypeLength,
    unsigned char *result)
{
    size_t i = 0, k = 0, byteLength = 0, n = 0;
...
size_t Jiajun_extract_fixed_length_bits(unsigned char *result,
    size_t intArrayLength,
    ...
    unsigned int bit_count)
{
    ...
    if (remainder_bit > 0) {
        switch (remainder_bit) {
            case 1:
                Jiajun_convertByte2UInt_fast_1b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength - 1) / 8 + 1,
                    unsignintArray);
                break;
            case 2:
                Jiajun_convertByte2UInt_fast_2b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength * 2 - 1) / 8 + 1,
                    unsignintArray);
                break;
            case 3:
                Jiajun_convertByte2UInt_fast_3b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength * 3 - 1) / 8 + 1,
                    unsignintArray);
                break;
            case 4:
                Jiajun_convertByte2UInt_fast_4b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength * 4 - 1) / 8 + 1,
                    unsignintArray);
                break;
            case 5:
                Jiajun_convertByte2UInt_fast_5b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength * 5 - 1) / 8 + 1,
                    unsignintArray);
                break;
            case 6:
                Jiajun_convertByte2UInt_fast_6b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength * 6 - 1) / 8 + 1,
                    unsignintArray);
                break;
            case 7:
                Jiajun_convertByte2UInt_fast_7b_args(intArrayLength,
                    result + byte_offset,
                    (intArrayLength * 7 - 1) / 8 + 1,
                    unsignintArray);
                break;
            default:
...
void Jiajun_convertByte2UInt_fast_1b_args(size_t intArrayLength,
...
void Jiajun_convertByte2UInt_fast_2b_args(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned int *intArray)
{
...
void Jiajun_convertByte2UInt_fast_3b_args(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned int *intArray)
{
...
void Jiajun_convertByte2UInt_fast_4b_args(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned int *intArray)
{
...
void Jiajun_convertByte2UInt_fast_5b_args(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned int *intArray)
{
...
void Jiajun_convertByte2UInt_fast_6b_args(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned int *intArray)
{
...
size_t convertIntArray2ByteArray_fast_1b(unsigned char *intArray,
    size_t intArrayLength,
    unsigned char **result)
{
    size_t byteLength = 0;
...
size_t convertIntArray2ByteArray_fast_1b_to_result(unsigned char *intArray,
    size_t intArrayLength,
    unsigned char *result)
{
    size_t byteLength = 0;
...
void convertByteArray2IntArray_fast_1b_args(size_t intArrayLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
...
void convertByteArray2IntArray_fast_1b(size_t intArrayLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
...
inline size_t convertIntArray2ByteArray_fast_2b_args(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char *result)
{
    register unsigned char tmp = 0;
 ...
 * @return
 */
size_t convertIntArray2ByteArray_fast_2b(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char **result)
{
...
void convertByteArray2IntArray_fast_2b(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
...
size_t convertIntArray2ByteArray_fast_3b(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char **result)
{
    size_t i = 0, k = 0, byteLength = 0, n = 0;
...
void convertByteArray2IntArray_fast_3b(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
    if (stepLength > byteArrayLength * 8 / 3) {
        printf(
            "Error: stepLength > byteArray.length*8/3, impossible case unless bugs elsewhere.\n");
        printf("stepLength=%zu, byteArray.length=%zu\n", stepLength, byteArrayLength);
        exit(0);
    }
    if (stepLength > 0)
...
size_t convertIntArray2ByteArray_fast_4b(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char **result)
{
    size_t i = 0, byteLength = 0, n = 0;
...
void convertByteArray2IntArray_fast_4b(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
...
size_t convertIntArray2ByteArray_fast_5b(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char **result)
{
    size_t i = 0, k = 0, byteLength = 0, n = 0;
...
void convertByteArray2IntArray_fast_5b(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
    if (stepLength > byteArrayLength * 8 / 5) {
        printf(
            "Error: stepLength > byteArray.length*8/5, impossible case unless bugs elsewhere.\n");
        printf("stepLength=%zu, byteArray.length=%zu\n", stepLength, byteArrayLength);
        exit(0);
    }
    if (stepLength > 0)
...
size_t convertIntArray2ByteArray_fast_6b(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char **result)
{
    size_t i = 0, k = 0, byteLength = 0, n = 0;
...
void convertByteArray2IntArray_fast_6b(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
    if (stepLength > byteArrayLength * 8 / 6) {
        printf(
            "Error: stepLength > byteArray.length*8/6, impossible case unless bugs elsewhere.\n");
        printf("stepLength=%zu, byteArray.length=%zu\n", stepLength, byteArrayLength);
        exit(0);
    }
    if (stepLength > 0)
...
size_t convertIntArray2ByteArray_fast_7b(unsigned char *timeStepType,
    size_t timeStepTypeLength,
    unsigned char **result)
{
    size_t i = 0, k = 0, byteLength = 0, n = 0;
...
void convertByteArray2IntArray_fast_7b(size_t stepLength,
    unsigned char *byteArray,
    size_t byteArrayLength,
    unsigned char **intArray)
{
    if (stepLength > byteArrayLength * 8 / 7) {
        printf(
            "Error: stepLength > byteArray.length*8/7, impossible case unless bugs elsewhere.\n");
        printf("stepLength=%zu, byteArray.length=%zu\n", stepLength, byteArrayLength);
        exit(0);
    }
    if (stepLength > 0)
